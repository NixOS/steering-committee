...
- [2026-04-22](./minutes/2026-04-22.md)
- [2026-04-15](./minutes/2026-04-15.md)
...
As per the process rule on [asynchronous voting](./docs/process/async-voting.md), the Steering Committee releases an exhaustive log of its non-confidential votes.


<!-- BEGIN VOTE LOGS -->
- [0023: Bootstrap Team Extension](./vote-logs/0024-bootstrap-team-extension.md)
- [0022: Approve Commercial Page Additions](./vote-logs/0023-approve-commercial-page-additions.md)
...
- [Vote #4: Proposal to bootstrap a "community team" with the help of alumni moderators](./vote-logs/0004-bootstrap-community-team.md)
- [Vote #3: Stabilize flakes (declaring flakes stable and shipping them as such)](./vote-logs/0003-stabilize-flakes.md)
- [Vote #2: approving constitutional change about no-confidence votes when some seats are vacant (PR #181)](./vote-logs/0002-constitutional-change-no-confidence-votes.md)
- [Vote #1: opening the nixos/steering-committee repository for minutes, decision logs, and process decisions](./vote-logs/0001-opening-steering-committee-repository.md)
<!-- END VOTE LOGS -->
